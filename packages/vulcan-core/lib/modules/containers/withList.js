...
const withList = (options) => {
  ...
  const { collection, limit = 10, pollInterval = getSetting('pollInterval', 20000), totalResolver = true, stopPollingIdleStatus = "INACTIVE", enableCache = false, extraQueries } = options,
